...
export const STATUS_TEXTS: Record<STATUS, string> = {
    ...
    [STATUS.STATUS_PARTIAL]: 'Partially Correct',
};

export const STATUS_SHORT_TEXTS: Partial<Record<STATUS, string>> = {
    [STATUS.STATUS_WAITING]: 'WJ',
    ...
    [STATUS.STATUS_CANCELED]: 'CL',
    [STATUS.STATUS_ETC]: 'UK',
    [STATUS.STATUS_HACKED]: 'HK',
    [STATUS.STATUS_JUDGING]: 'RN',
    [STATUS.STATUS_COMPILING]: 'CP',
    [STATUS.STATUS_FETCHED]: 'FT',
    [STATUS.STATUS_IGNORED]: 'IG',
    [STATUS.STATUS_FORMAT_ERROR]: 'FE',
    [STATUS.STATUS_PARTIAL]: 'PC',
};
...
export function getScoreColor(score: number | string): string {
    ...
    return [
        ...
        '#93b127',
        '#25ad40',
    ][Math.min(Math.max(Math.floor((Number(score) || 0) / 10), 0), 10)];
}
